...
#define UART2_BASE		(RPi_IO_Base_Addr + 0x00201400)
...
#define UART2_DR		(*(volatile uint32_t*)(UART2_BASE + 0x00))
...
// bit 1:	 PE			パリティエラー
// bit 0:	 FE			フレーミングエラー
#define UART2_RSRECR	(*(volatile uint32_t*)(UART2_BASE + 0x04))
...
// bit 0:	 CTS		送信クリア
#define UART2_FR		(*(volatile uint32_t*)(UART2_BASE + 0x18))

/* 整数ボーレート除数レジスタ */
// bit31-16:			予約 0固定
// bit15- 0: IBRD		バンドレートディバイダー(整数部分)
//						IBRD = 3,000,000/(16*Baudrate)
#define UART2_IBRD		(*(volatile uint32_t*)(UART2_BASE + 0x24))

/* 小数ボーレート除数レジスタ */
// bit31- 6:			予約 0固定
// bit 5- 0: FBRD		バンドレートディバイダー(小数部分)
//						FBRD = (24,000,000/Baudrate-IBRD*128+1)/2
#define UART2_FBRD		(*(volatile uint32_t*)(UART2_BASE + 0x28))
...
#define UART2_LCRH		(*(volatile uint32_t*)(UART2_BASE + 0x2C))
...
#define UART2_CR		(*(volatile uint32_t*)(UART2_BASE + 0x30))
...
#define UART2_IFLS		(*(volatile uint32_t*)(UART2_BASE + 0x34))
...
// bit 0:	 RIMIM		未サポート
#define UART2_IMSC		(*(volatile uint32_t*)(UART2_BASE + 0x28))
...
// bit 0:	 RIMRIS		未サポート
#define UART2_RIS		(*(volatile uint32_t*)(UART2_BASE + 0x3C))
...
// bit 0:	 RIMMIS		未サポート
#define UART2_MIS		(*(volatile uint32_t*)(UART2_BASE + 0x40))
...
// bit 0:	 RIMIC		未サポート
#define UART2_ICR		(*(volatile uint32_t*)(UART2_BASE + 0x44))

#define UART2_ITCR		(*(volatile uint32_t*)(UART2_BASE + 0x80))
#define UART2_ITIP		(*(volatile uint32_t*)(UART2_BASE + 0x84))
#define UART2_ITOP		(*(volatile uint32_t*)(UART2_BASE + 0x88))
#define UART2_TDR		(*(volatile uint32_t*)(UART2_BASE + 0x8C))
